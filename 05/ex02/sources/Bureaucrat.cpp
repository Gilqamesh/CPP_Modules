...
void	Bureaucrat::signForm(Form &a) const
{
	...
	{
		a.beSigned(*this);
		std::cout << name << " signs the form: " << "\"" << a.getName() << "\"" << std::endl;
	}
	catch (std::exception &e)
	{
		std::cout << name << " cannot sign the form: " << a.getName() << " because "
			<< e.what() << std::endl;
	}
}

void	Bureaucrat::executeForm(const Form &a) const
{
	try
	{
		a.execute(*this);
	...
	{
		std::cout << name << " cannot execute the form: " << a.getName() << " because "
			<< e.what() << std::endl;
	}
}
...
range_error("Bureaucrat's grade is too high") { }
...
range_error("Bureaucrat's grade is too low") { }
